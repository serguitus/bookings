    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency', models.CharField(choices=[('CUC', 'CUC'), ('USD', 'USD'), ('EUR', 'EUR'), ('CUP', 'CUP')], default='USD', max_length=5)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency', models.CharField(choices=[('CUC', 'CUC'), ('USD', 'USD'), ('EUR', 'EUR'), ('CUP', 'CUP')], max_length=5)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('matched_amount', models.DecimalField(decimal_places=2, default=0, max_digits=10, verbose_name='Matched')),
                ('match_amount', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('finantialdocument_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='finance.FinantialDocument')),
                ('exchange_amount', models.DecimalField(decimal_places=2, default=0, max_digits=10, verbose_name='Origin Amount')),
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='accounting.Account')),
                ...
                ('exchange_account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='exchange_account', to='accounting.Account', verbose_name='Origin Account')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('finantialdocument_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='finance.FinantialDocument')),
                ('operation_cost', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='accounting.Account')),
                ('current_operation', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='accounting.Operation')),
                ('transfer_account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='transfer_account', to='accounting.Account', verbose_name='Origin Account')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='loanaccountdocument',
            name='loan_account',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='finance.LoanAccount'),
        ),
        migrations.AlterUniqueTogether(
            name='loanaccount',
