...
class FinanceServicesTestCase(FinanceBaseTestCase):
    ...
    def test_save_agency_payment_status_draft(self):
        ...
        self.assertDocument(agency_payment, DOC_TYPE_AGENCY_PAYMENT, test_account.currency)
        ...
        self.assertFinantialHistory(
            test_finantial_history=finantial, test_document=agency_payment, test_user=self.test_user,
    ...
    def test_save_agency_payment_status_ready(self):
        """
        Does ready agency_payment
        """
        test_account = Account.objects.create(
            name='Test Account',
            currency=CURRENCY_CUC)
    ...
    def test_save_agency_payment_draft_then_ready(self):
        """
        Does draft agency_payment and then change to ready
        """
        test_account = Account.objects.create(
            name='Test Account',
            currency=CURRENCY_CUC)
    ...
    def test_save_agency_payment_ready_then_draft(self):
        """
        Does ready agency_payment and then change to draft
        """
        test_account = Account.objects.create(
            name='Test Account',
            currency=CURRENCY_CUC)
    ...
    def test_save_agency_payment_ready_then_draft_account(self):
        """
        Does ready agency_payment and then change to draft and account
        """
        ...
        # document data auto filled
        self.assertDocument(agency_payment, DOC_TYPE_AGENCY_PAYMENT, test_account1.currency)
        ...
        # document data auto filled
        self.assertDocument(agency_payment, DOC_TYPE_AGENCY_PAYMENT, test_account2.currency)
    ...
    def test_save_agency_payment_draft_then_amount(self):
        """
        Does draft agency_payment and then change amount
        """
        test_account = Account.objects.create(
            name='Test Account',
            currency=CURRENCY_CUC)
    ...
    def test_save_agency_payment_ready_then_amount(self):
        """
        Does ready agency_payment and then change amount
        """
        test_account = Account.objects.create(
            name='Test Account',
            currency=CURRENCY_CUC)
    ...
    def test_save_agency_payment_draft_then_account(self):
        """
        Does draft agency_payment and then change account
        """
        test_account1 = Account.objects.create(
            name='Test Account1',
            currency=CURRENCY_CUC)
    ...
    def test_save_agency_payment_ready_then_account(self):
        """
        Does ready agency_payment and then change account
        """
        test_account1 = Account.objects.create(
            name='Test Account1',
            currency=CURRENCY_CUC)
    ...
    def test_save_agency_payment_ready_then_amount_account(self):
        """
        Does ready agency_payment and then change amount and account
        """
        test_account1 = Account.objects.create(
            name='Test Account1',
            currency=CURRENCY_CUC)
    ...
    def test_save_agency_payment_ready_then_date(self):
        """
        Does ready agency_payment and then change to draft
        """
        test_account = Account.objects.create(
