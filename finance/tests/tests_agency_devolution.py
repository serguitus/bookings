...
class FinanceServiceTestCase(FinanceBaseTestCase):
    ...
    def test_save_agency_devolution_status_draft(self):
        ...
        agency_devolution = AgencyDevolution(
        ...
        self.assertDocument(agency_devolution, DOC_TYPE_AGENCY_DEVOLUTION, test_account.currency)
        ...
        self.assertFinantialHistory(
            test_finantial_history=finantial, test_document=agency_devolution, test_user=self.test_user,
    ...
    def test_save_agency_devolution_draft_then_ready(self):
        """
        Does draft agency_devolution and then change to ready
        """
        test_account = Account.objects.create(
            name='Test Account',
            currency=CURRENCY_CUC,
    ...
    def test_save_agency_devolution_ready_then_draft(self):
        """
        Does ready agency_devolution and then change to draft
        """
        test_account = Account.objects.create(
            name='Test Account',
            currency=CURRENCY_CUC,
    ...
    def test_save_agency_devolution_ready_then_draft_account(self):
        """
        Does ready agency_devolution and then change to draft and account
        """
        ...
        # document data auto filled
        self.assertDocument(agency_devolution, DOC_TYPE_AGENCY_DEVOLUTION, test_account1.currency)
        ...
        # document data auto filled
        self.assertDocument(agency_devolution, DOC_TYPE_AGENCY_DEVOLUTION, test_account2.currency)
    ...
    def test_save_agency_devolution_draft_then_amount(self):
        """
        Does draft agency_devolution and then change amount
        """
        test_account = Account.objects.create(
            name='Test Account',
            currency=CURRENCY_CUC,
    ...
    def test_save_agency_devolution_ready_then_amount(self):
        """
        Does ready agency_devolution and then change amount
        """
        test_account = Account.objects.create(
            name='Test Account',
            currency=CURRENCY_CUC,
    ...
    def test_save_agency_devolution_draft_then_account(self):
        """
        Does draft agency_devolution and then change account
        """
        test_account1 = Account.objects.create(
            name='Test Account1',
            currency=CURRENCY_CUC,
    ...
    def test_save_agency_devolution_ready_then_account(self):
        """
        Does ready agency_devolution and then change account
        """
        test_account1 = Account.objects.create(
            name='Test Account1',
            currency=CURRENCY_CUC,
    ...
    def test_save_agency_devolution_ready_then_amount_account(self):
        """
        Does ready agency_devolution and then change amount and account
        """
        test_account1 = Account.objects.create(
            name='Test Account1',
            currency=CURRENCY_CUC,
    ...
    def test_save_agency_devolution_draft_then_date(self):
        """
        Does draft agency_devolution and then change date
        """
        test_account = Account.objects.create(
            name='Test Account',
            currency=CURRENCY_CUC,
        ...
        test_name1 = agency_devolution.name
        ...
        test_name2 = agency_devolution.name
    ...
    def test_save_agency_devolution_ready_then_date(self):
        """
        Does ready agency_devolution and then change to draft
        """
        test_account = Account.objects.create(
