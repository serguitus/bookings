...
from finance.constants import STATUS_DRAFT, STATUS_READY, DOC_TYPE_LOAN_ENTITY_WITHDRAW
from finance.models import LoanEntityWithdraw, LoanEntity
...
class FinanceServicesTestCase(FinanceBaseTestCase):
    ...
    def test_save_loan_entity_withdraw_status_draft(self):
        """
        Does draft loan_entity_withdraw
        """
        ...
        self.assertDocument(
            loan_entity_withdraw, DOC_TYPE_LOAN_ENTITY_WITHDRAW, test_account.currency)

        # one finantial history created
        finantials = loan_entity_withdraw.finantialdocumenthistory_set
        self.assertEqual(finantials.count(), 1)

        # finantial history info
        finantial = finantials.first()
        self.assertFinantialHistory(
            test_finantial_history=finantial, test_document=loan_entity_withdraw,
            test_user=self.test_user, test_old_status=None, test_new_status=test_status)

        # no accounting history created
        accountings = loan_entity_withdraw.accountingdocumenthistory_set
        self.assertEqual(accountings.count(), 0)

    def test_save_loan_entity_withdraw_status_ready(self):
        """
        Does ready loan_entity_withdraw
        """
        test_account = Account.objects.create(
            name='Test Account',
            currency=CURRENCY_CUC,
    ...
    def test_save_loan_entity_withdraw_draft_then_ready(self):
        """
        Does draft loan_entity_withdraw and then change to ready
        """
        test_account = Account.objects.create(
            name='Test Account',
            currency=CURRENCY_CUC,
        ...
        loan_entity_withdraw.status = test_status2
    ...
    def test_save_loan_entity_withdraw_ready_then_draft(self):
        """
        Does ready loan_entity_withdraw and then change to draft
        """
        test_account = Account.objects.create(
            name='Test Account',
            currency=CURRENCY_CUC,
    ...
    def test_save_loan_entity_withdraw_ready_then_draft_account(self):
        """
        Does ready loan_entity_withdraw and then change to draft and account
        """
        ...
        # document data auto filled
        self.assertDocument(
            loan_entity_withdraw, DOC_TYPE_LOAN_ENTITY_WITHDRAW, test_account1.currency)
        ...
        # document data auto filled
        self.assertDocument(
            loan_entity_withdraw, DOC_TYPE_LOAN_ENTITY_WITHDRAW, test_account2.currency)
    ...
    def test_save_loan_entity_withdraw_draft_then_amount(self):
        """
        Does draft loan_entity_withdraw and then change amount
        """
        test_account = Account.objects.create(
            name='Test Account',
            currency=CURRENCY_CUC,
        ...
        loan_entity_withdraw.amount = test_amount2
    ...
    def test_save_loan_entity_withdraw_ready_then_amount(self):
        """
        Does ready loan_entity_withdraw and then change amount
        """
        test_account = Account.objects.create(
            name='Test Account',
            currency=CURRENCY_CUC,
    ...
    def test_save_loan_entity_withdraw_draft_then_account(self):
        """
        Does draft loan_entity_withdraw and then change account
        """
        test_account1 = Account.objects.create(
            name='Test Account1',
            currency=CURRENCY_CUC,
    ...
    def test_save_loan_entity_withdraw_ready_then_account(self):
        """
        Does ready loan_entity_withdraw and then change account
        """
        test_account1 = Account.objects.create(
            name='Test Account1',
            currency=CURRENCY_CUC,
    ...
    def test_save_loan_entity_withdraw_ready_then_amount_account(self):
        """
        Does ready loan_entity_withdraw and then change amount and account
        """
        test_account1 = Account.objects.create(
            name='Test Account1',
            currency=CURRENCY_CUC,
    ...
    def test_save_loan_entity_withdraw_draft_then_date(self):
        """
        Does draft loan_entity_withdraw and then change date
        """
        test_account = Account.objects.create(
            name='Test Account',
            currency=CURRENCY_CUC,
        ...
        loan_entity_withdraw.date = test_date2

        loan_entity_withdraw = FinanceServices.save_loan_entity_withdraw(
            user=self.test_user,
            loan_entity_withdraw=loan_entity_withdraw)

        test_name2 = loan_entity_withdraw.name
    ...
    def test_save_loan_entity_withdraw_ready_then_date(self):
        """
        Does ready loan_entity_withdraw and then change to draft
        """
        test_account = Account.objects.create(
