...
ROOM_TYPE_SINGLE = 'SNGL'
ROOM_TYPE_DOUBLE = 'DBL'
ROOM_TYPE_TRIPLE = 'TRPL'
ROOM_TYPE_QUAD = 'QDRPL'
ROOM_TYPE_MULTI = 'MLTPL'
ROOM_TYPES = (
    (ROOM_TYPE_SINGLE, 'Single'),
    (ROOM_TYPE_DOUBLE, 'Double'),
    (ROOM_TYPE_TRIPLE, 'Triple'),
    (ROOM_TYPE_QUAD, 'Quadruple'),
    (ROOM_TYPE_MULTI, 'Multiple'),
)
