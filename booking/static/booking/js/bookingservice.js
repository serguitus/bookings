(function($) {
    $(document).ready(function() {
        ...
        label.html(
            label.html() +
            '<a id="btn-booking-services-summary" title="Booking Services Summary" data-toggle="modal" data-target="#booking_services_summary" class="btn btn-booking-services-summary fa fa-eye" href="#"></a>'
        );
        label = $("div.field-booking_package div label.required");
        label.html(
            label.html() +
            '<a id="btn-bookingpackage-services-summary" title="Booking Package Services Summary" data-toggle="modal" data-target="#bookingpackage_services_summary" class="btn btn-bookingpackage-services-summary fa fa-eye" href="#"></a>'
        );
        ...
        function show_buttons() {
            ...
            if (field[0] != undefined) {
                $("#id_cost_amount").after(
                    '<button id="btn-cost" class="btn btn-copy-cost"><<</button><span id="span-cost" class="computed-value">N/A</span>'
                );
                $("#id_price_amount").after(
                    '<button id="btn-price" class="btn btn-copy-price"><<</button><span id="span-price" class="computed-value">N/A</span>'
                );
                ...
                if (field[0] != undefined) {
                    $("div.field-cost_amount div.readonly").after(
                        '<span id="span-cost" class="computed-value">N/A</span>'
                    );
                    $("div.field-price_amount div.readonly").after(
                        '<span id="span-price" class="computed-value">N/A</span>'
                    );
                }
            }
