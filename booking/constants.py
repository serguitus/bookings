...
QUOTESERVICE_TYPES = {
    ...
    QUOTE_SERVICE_CATEGORY_QUOTE_DETAIL_ALLOTMENT: 'quotebookdetailallotment',
    QUOTE_SERVICE_CATEGORY_QUOTE_DETAIL_TRANSFER: 'quotebookdetailtransfer',
    QUOTE_SERVICE_CATEGORY_QUOTE_DETAIL_EXTRA: 'quotebookdetailextra',
}
